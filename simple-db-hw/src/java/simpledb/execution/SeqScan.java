...
public class SeqScan implements OpIterator {
    ...
    public TupleDesc getTupleDesc() {
    	...
    	if(prefixeDesc == null) {
        	...
        	String[] fieldsname = new String[origin.numFields()];
        	for(int i=0;i<origin.numFields();i++) {
        		types[i] = origin.getFieldType(i);
        		fieldsname[i]= tableAlias + "." + origin.getFieldName(i); 
        	}
        	prefixeDesc = new TupleDesc(types, fieldsname);
    	}
        return prefixeDesc;
    }
